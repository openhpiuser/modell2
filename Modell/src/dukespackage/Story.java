...
public class Story {
	...
	public static void main(String[] args) {
		...
		System.out.println(lineSeparator +"Duke betritt das Hauptquartier und findet als erstes die Küche," + lineSeparator 
		...
		System.out.println(lineSeparator + "Duke nimmt das Hauptquartier auch gleich in Besitz, da kennt er nix");
